  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f1419] px-4">
      <div className="w-full max-w-sm animate-[fadeInUp_0.6s_cubic-bezier(0.22,1,0.36,1)_both]">
        ...
        <h1 className="text-white text-2xl font-semibold mb-2 animate-[fadeInUp_0.5s_cubic-bezier(0.22,1,0.36,1)_0.3s_both]">Create your account</h1>
        <p className="text-white/50 text-sm mb-8 animate-[fadeInUp_0.5s_cubic-bezier(0.22,1,0.36,1)_0.4s_both]">Start automating your college outreach today.</p>
